...
namespace _1271713_ADO.NetCCProjectByNewaz.NewazProjectDBDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [Name] = @Name, [Address] = @Address WHERE (([CustId]" +
                " = @Original_CustId) AND ([Name] = @Original_Name) AND ([Address] = @Original_Ad" +
                "dress));\r\nSELECT CustId, Name, Address FROM Customer WHERE (CustId = @CustId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustId, Name, Address FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_CustId, string Original_Name, string Original_Address) {
        ...
        public virtual int Update(string Name, string Address, int Original_CustId, string Original_Name, string Original_Address, int CustId) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, int Original_CustId, string Original_Name, string Original_Address) {
            return this.Update(Name, Address, Original_CustId, Original_Name, Original_Address, Original_CustId);
        }
    }
